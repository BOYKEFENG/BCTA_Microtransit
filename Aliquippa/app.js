...
require([
    ...
    const combinedBG = new FeatureLayer({
      url: "https://services1.arcgis.com/HmwnYiJTBZ4UkySc/arcgis/rest/services/Aliquippa_OD_Merge12/FeatureServer/1",
      id: "Combined_BG",
    ...
    const odTable = new FeatureLayer({
      url: "https://services1.arcgis.com/HmwnYiJTBZ4UkySc/arcgis/rest/services/Aliquippa_OD_Merge12/FeatureServer/2",
      id: "OD_Table",
      outFields: ["*"],  // This will fetch all fields
      visible: true,
      opacity: 0.7,
    ...
    const originBG = new FeatureLayer({
        url: "https://services1.arcgis.com/HmwnYiJTBZ4UkySc/arcgis/rest/services/Aliquippa_OD_Merge12/FeatureServer/0",
        id: "Origin_BG",
        outFields: ["*"],
        visible: true,
        opacity: 0.7,
